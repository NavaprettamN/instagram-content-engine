// Dependency-free line-icon set (Feather/Lucide style). Stroke uses
// currentColor so icons inherit text color; size via the `size` prop.
// Keeps the dashboard self-contained — no icon library to install.

export type IconName =
  | "grid" | "sliders" | "eye" | "activity" | "users" | "trending-up"
  | "heart" | "message" | "bookmark" | "share" | "link" | "film"
  | "image" | "bar-chart" | "target" | "check" | "x" | "external"
  | "logout";
...
const PATHS: Record<IconName, React.ReactNode> = {
  ...
  message: <path d="M21 11.5a8 8 0 0 1-11.6 7.1L3 20l1.4-6.4A8 8 0 1 1 21 11.5Z" />,
